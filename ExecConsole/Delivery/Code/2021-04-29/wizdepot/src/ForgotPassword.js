      ...
      <div className="col-12 forgot-margin"> 
          <div className="login-form text-center col-lg-4 col-md-5 col-sm-9">  
              ...
              <div className="input-group my-3">
                  ...
                  <input type="text" name='email' value={this.state.fields.email} onChange={this.handleChange} className={`form-control ${this.state.errors["email"] ? this.state.errors["email"] : ''}`}  placeholder="Email Address" />
              </div>
